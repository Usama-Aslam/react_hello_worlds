  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <div>
        <h2>Q1) Render these into component:</h2>
        <p>const name = "Hello World";</p>
        <p>const obj = &#123;name: "Hello World Object"&#125;</p>
        <p>const data = ['We', 'are', 'United'] //Show these in seperate tags</p>
        <p>const list = [&#123;name: "Hello World 1"&#125;, &#123;name: "Hello World 2"&#125;, &#123;name: "Hello World 3"&#125;] //Show these in seperate tags</p> 
      <h3>Answers :</h3>
      <p>1.{name}</p>
      <p>2.{obj.name}</p>
      <ul>
      ...
      <ul>
        {complex.map(value=>{
          return <li>{value.company}{value.jobs.map(innervalue=>{
            return <ul>
                      <li>{innervalue}</li>
                  </ul>
          })}</li>
